...
🔴 **격차 5건은 전부 *지금 못 하는* 것이다** — 시간·외부 접근·소유자 행동을 기다린다:

| | 왜 |
|---|---|
| `R5-24` | 스킬에 **SHA 핀 장치가 없다** — 선결 조건 |
| `R5-26` | **의도적 대기** — 상상으로 만들면 일곱 번째 하네스 |
| `R5-27` | 1차 출처 둘이 **403 · 미특정** |
| `R5-37` | **2주 관측**(2026-09-11 이후) — 계기는 달렸고 눈금이 4/4 로 움직였다 |
| `R5-39` | 린트 규칙군 확장 중 — **열둘** 켰고(`ruff.toml` 이 정본) 남은 것은 `D` 239 · `mypy` 38. `PT` 는 기각 |
...
지금 **5건**(`R5-24`·`R5-26`·`R5-27`·`R5-37`·`R5-39`)이고 **왜 지금 못 하는지**는 §⏭️ 다음 세션이 할 일에 있다.
