...
`R5-37` 계기([`#224`](https://github.com/coolbress/standards/pull/224)). 갈래는 셋뿐이다 —
**지표가 한쪽만 셈**(4) · **구조화된 줄을 부분문자열로 훑음**(4) · **예시가 데이터로 세어짐**(4).
...
| 3 | `R5-40` ⓒ 다음 층 — **리뷰 처분 계약** | 🟡 **20건 뒤** | 계기 **8건** / `ENOUGH=20`. 재판정할 재료가 없다 |
