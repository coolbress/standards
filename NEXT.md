...
🔴 **앞의 다섯 실패와 다른 점: 1~5 는 *거짓 빨강* 이라 시끄러웠고, 이건 *거짓 초록* 이라 아무 소리도 안 났다.**
전문은 [`direction/07`](direction/07-design-rules.md) §반복해서 무는 실패.

## 🔬 2026-09-01 (5차) — **리뷰가 11회차까지 갔고 findings 20건이 전부 진짜였다**

`R5-37` 계기([`#224`](https://github.com/coolbress/standards/pull/224)). **findings 32건**(P1 3 · P2 29 · CodeQL 1).
