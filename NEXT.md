...
| 묻는 것 | 정본 |
|---|---|
| **격차가 몇 건 남았나** | `python3 tools/check_gaps_ledger.py` — 지금 **5건** (⚠️ 이 줄은 **낡는다.** 🔴 **수를 인용하기 전에 명령을 돌려라** — 2026-09-01 에 이 줄이 5 로 남아 제3자에게 잡혔다) |
...
> 갱신 **2026-09-01 (4차 · GitLab 프로브 + R5-37 뒤)**. 열린 격차 **5**(`check_gaps_ledger` 가 정본).
