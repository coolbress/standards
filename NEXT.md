...
| | |
|---|---|
| `IPW-021` **c-CRAB** | 리뷰 코멘트를 **실행 가능한 시험**으로 바꿔 오라클로 쓴다. 사람 **100%** vs Claude Code **32.1%** · Codex **20.1%** · **넷 합쳐 41.5%**. 🎯 그런데 **코멘트 84%는 유용** — 격차는 *소음* 이 아니라 **우선순위 차이**, 최강 지렛대는 **저장소 고유 맥락** |
...
🔴 **아직 안 만든다** — 표본 **17 < 20**. **내용과 재료는 갖춰졌고 표본만 남았다.**
...
🚫 **자체 런타임은 안 만든다** · 🚫 **Claude 액션 기각**(종량제).
