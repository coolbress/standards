...
| # | 할 일 | 지금 되나 | 왜 그 순서 |
|---|---|---|---|
| **1** | **`R5-44` — GitLab 3종 실측**<br>① Developer 토큰이 `push_access_level: 0` 브랜치에 **정말 못 미나** ② 파이프라인 실패가 **머지를 정말 막나** ③ **Free SAST/시크릿이 보고만 하고 끝나나** | ✅ **소유자가 계정을 만들었다(2026-09-01)** | **반나절**. 그리고 *비공개·외부* 범위를 **실제로** 넓히는 유일한 항목 |
