...
- `[lit]` **OpenSSF Scorecard / Pinned-Dependencies** — independently confirms pinning is weak in the wild (Pinned-Deps mean **3.1/10**, weighted 3.8; **27% uniform / 37% weighted** strong · n=429), reinforcing the ⚖️ uplift. https://scorecard.dev/
