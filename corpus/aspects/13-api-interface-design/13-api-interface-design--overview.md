...
> **Evidence:** [lit] SWEBOK v4 KA2/KA3, OpenAPI 3.2, AsyncAPI 3.1, RFC 9110 · **Confidence:** High (named standards) · **Kind:** gated[library/cli/backend] · **Stage:** ③
...
- [lit] **SWEBOK v4.0** (IEEE CS, Oct 2024) — KA *Software Design* (KA2): API = signatures + semantics; Design by Contract (pre/postconditions). KA *Software Construction* (KA3): constructing to documented interfaces. https://ieeecs-media.computer.org/media/education/swebok/swebok-v4.pdf
...
- [lit] **RFC 9110 — HTTP Semantics** — safe vs idempotent methods; GET/HEAD/OPTIONS/TRACE safe; +PUT/DELETE idempotent; POST neither (motivates idempotency keys). https://www.rfc-editor.org/rfc/rfc9110.html
