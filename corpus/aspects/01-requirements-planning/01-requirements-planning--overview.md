...
- [`facts-2026-08-requirements.md`](facts-2026-08-requirements.md) — *research-log (ko)* — 2026-08 facts-only pass: ISO-29148 · 3C · INVEST · GWT/EARS · Mom Test · PRD/1-pager · PR/FAQ · Shape Up pitch/appetite, per-claim URLs + source-tier tags.
- [`facts-2026-08-estimation-failure-data.md`](facts-2026-08-estimation-failure-data.md) — *research-log (ko)* — 2026-08 facts-only pass: CHAOS figures + Eveleens&Verhoef critique side-by-side · McKinsey-Oxford · Boehm curve + 2001 revision · Cone of Uncertainty · Jørgensen estimation data · scope-creep stats · AI-impact figures (secondary-source flagged).
