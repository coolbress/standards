...
- **SWEBOK Guide v4.0** (IEEE CS, 2024) — KA *Software Architecture* + KA *Software Design*: architecture = significant structures/decisions; design styles, quality-attribute analysis. [lit, normative] https://www.computer.org/education/bodies-of-knowledge/software-engineering
